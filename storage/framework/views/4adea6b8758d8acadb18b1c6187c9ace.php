    ...
    <div class="dash-main">
        ...
        <div class="dash-body">
            <div class="dash-main">
                ...
                <div class="dash-body">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeGroup): ?>
                    <?php echo $__env->make('student.groups.show',
                    [
                    'group' => $activeGroup,
                    'admin' => $admin,
                    'members' => $members,
                    ...
                    <?php else: ?>
                    <?php echo $__env->make('student.groups.index',[
                    'myGroups' => $myGroups,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Recess-work\resources\views/student/dashboard.blade.php ENDPATH**/ ?>