    ...
    <div class="dash-main" style="flex:1;">
        ...
        <div class="group-dash-body">
            ...
            <div class="group-search-bar">
                <input type="text" class="form-control" placeholder="🔍 Search discussions..." style="max-width:450px;">
            </div>
            ...
            <div class="group-discussion-stack">
                    ...
                    <div class="discussion-footer">
                        <div class="discussion-meta">
                            ...
                            <span>
                                ...
                                {{ $discussion->created_at?->diffForHumans() ?? 'Unknown date' }}

                            </span>
                        </div>
                        <a href="/groups/{{ $group->id }}/discussions/{{ $discussion->id }}"
                            class="group-btn group-btn-outline group-btn-sm">
                ...
                <div class="group-discussion-item" style="text-align:center; padding:60px;">
                    ...
                    <a href="/groups/{{ $group->id }}/discussions/create" class="group-btn group-btn-primary"
