                ...
                <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(280px, 1fr)); gap:16px;">
                    ...
                    <div class="group-card" data-name="{{ $group->name }}"
                        ...
                        <div style="display:flex; align-items:center; gap:10px;">
                            <div
                                style="background:#ede9fe; border-radius:10px; width:42px; height:42px; display:flex; align-items:center; justify-content:center;">
                                <i class="ti ti-users-group" style="color:#4f46e5; font-size:20px;"></i>
                            </div>
                            <div>
                                <div style="font-weight:600; font-size:15px;">{{ $group->name }}</div>
                                <div style="font-size:12px; color:#6b7280;">{{ $group->discussions()->count() }}
                                    discussions</div>
                            </div>
                        </div>
                    ...
                    @empty
                    <div
                        style="background:#f9fafb; border:1px dashed #d1d5db; border-radius:12px; padding:32px; text-align:center; color:#9ca3af;">
            ...
            <div>
                ...
                <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(280px, 1fr)); gap:16px;">
                    ...
                    <div class="group-card" data-name="{{ $group->name }}"
                        ...
                        <div style="display:flex; align-items:center; gap:10px;">
                            <div
                                style="background:#d1fae5; border-radius:10px; width:42px; height:42px; display:flex; align-items:center; justify-content:center;">
