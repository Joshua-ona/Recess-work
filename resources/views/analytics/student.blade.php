...
<div class="dash-wrap">
    ...
    <div class="dash-main">
        ...
        <div class="dash-header">
            <div>
                @if(!empty($backRoute))
                <a href="{{ $backRoute }}" class="link-sm"
        ...
        <div class="stat-grid">
            <div class="stat-card">
                <div class="stat-label">
                    <span class="stat-icon" style="background:var(--purple-50);"><i class="ti ti-star"
                            style="color:var(--purple-600);"></i></span>
                    Overall score
                </div>
            ...
            <div class="stat-card">
                <div class="stat-label">
                    <span class="stat-icon" style="background:var(--teal-50);"><i class="ti ti-clipboard-check"
                            style="color:var(--teal-600);"></i></span>
                    Avg quiz score
                </div>
                <div class="stat-value">{{ $overall_avg_pct }}%</div>
                @if($trend_delta !== null)
                <div class="stat-change {{ $trend_delta >= 0 ? 'text-pos' : 'text-neg' }}">
                    <i class="ti ti-trending-{{ $trend_delta >= 0 ? 'up' : 'down' }}"></i>
                    {{ $trend_delta >= 0 ? '+' : '' }}{{ $trend_delta }}% vs earlier attempts
                </div>
                @endif
            </div>
            <div class="stat-card">
                <div class="stat-label">
                    <span class="stat-icon" style="background:var(--blue-50);"><i class="ti ti-list-check"
                            style="color:var(--blue-600);"></i></span>
                    Quizzes taken
                </div>
            ...
            <div class="stat-card">
                <div class="stat-label">
                    <span class="stat-icon" style="background:var(--amber-50);"><i class="ti ti-messages"
                            style="color:var(--amber-600);"></i></span>
                    Discussions started
                </div>
            ...
            <div class="stat-card">
                <div class="stat-label">
                    <span class="stat-icon" style="background:var(--pink-50);"><i class="ti ti-message-2"
                            style="color:var(--pink-600);"></i></span>
                    Replies posted
                </div>
            ...
            <div class="stat-card">
                <div class="stat-label">
                    <span class="stat-icon" style="background:var(--green-50);"><i class="ti ti-users-group"
                            style="color:var(--green-600);"></i></span>
                    Group participation
                </div>
                <div class="stat-value">{{ $participation_rate !== null ? $participation_rate.'%' : '—' }}</div>
                <div class="stat-change text-muted">of discussions in {{ $groups_joined }} joined
                    {{ Str::plural('group', $groups_joined) }}</div>
            </div>
        </div>
        ...
        <div class="panel-grid">
            ...
            <div class="panel">
                <div class="panel-head">
                    <span class="panel-title">Discussion activity (last {{ count($discussion_trend['labels']) }}
                        days)</span>
                </div>
                <div class="panel-body">
                ...
                <div class="panel-body">
                    ...
                    <div class="progress-wrap" style="margin-top:8px;margin-bottom:0;">
                        ...
                        <div class="progress-bar">
                            <div class="progress-fill" style="width:{{ $best_quiz_pct }}%;background:var(--teal-600);">
                            </div>
                        </div>
                    </div>
                    @else
                    ...
                    <div class="progress-wrap" style="margin-top:8px;margin-bottom:0;">
                        ...
                        <div class="progress-bar">
                            <div class="progress-fill"
                                style="width:{{ $weakest_quiz_pct }}%;background:var(--red-400);"></div>
                        </div>
                    </div>
                    @else
                    <p class="text-muted" style="font-size:13px;">No data yet.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('quizScoreChart'), {
        ...
        data: {
            labels: {
                !!json_encode($quiz_labels) !!
            },
            datasets: [{
                    label: 'My score (%)',
                    data: {
                        !!json_encode($my_scores) !!
                    },
                    borderColor: '#534AB7',
    ...
    new Chart(document.getElementById('activityChart'), {
        ...
        data: {
            labels: {
                !!json_encode($discussion_trend['labels']) !!
            },
            datasets: [{
                    label: 'Discussions started',
                    data: {
                        !!json_encode($discussion_trend['counts']) !!
                    },
                ...
                },
                {
                    ...
                    data: {
                        !!json_encode($reply_trend['counts']) !!
                    },
